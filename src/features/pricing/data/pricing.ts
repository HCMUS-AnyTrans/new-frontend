...
export const pricingFAQ: FAQItem[] = [
  {
    ...
    answer:
      'Không. Credits không có ngày hết hạn, bạn có thể dùng bất kỳ lúc nào.',
  },
  {
    question: 'Tôi dùng cho team được không?',
    answer:
      'Có. Gói Pro hỗ trợ team access, hoặc liên hệ Enterprise để được tư vấn giải pháp phù hợp.',
  },
  {
    question: 'PDF 200 trang thì tốn bao nhiêu credit?',
    answer:
      '200 credits. Mỗi trang = 1 credit, tính theo số trang thực tế của tài liệu.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Credits không hoàn tiền, nhưng bạn có thể dùng thử miễn phí trước khi mua.',
  },
];
